                    ...
                    <ul class="sidebar-menu">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route ('klub')}}">Klub Sepak Bolak</a></li>
                                <li><a class="nav-link" href="{{ route ('official')}}">Official Team</a></li>
                                <li><a class="nav-link" href="{{ route ('pemain')}}">Pemain</a></li>
                            </ul>
                        </li>
