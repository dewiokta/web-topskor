            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a class="text-light" href="#"><img src="../images/logo-topskor.png" height="100" alt=""><span>LIGA TOPSKOR</span></a>
                    </div>
                    <br>
                    ...
                    <ul class="sidebar-menu">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="#">Klub Sepak Bola</a></li>
                                <li><a class="nav-link" href="#">Official Team</a></li>
                                <li><a class="nav-link" href="#">Manajer</a></li>
                            </ul>
                        </li>
